<script>
	...
	$: visible = x !== undefined && y !== undefined && song.length > 0 && !$currentStoryStep.visualEncodings.showAggregateSnakeChart && !$currentStoryStep.showLoveSongTypeTableWithThisHighlighted;
