<script>
    ...
    let sortedSongTypes = [];
    $: typesMarkedAsNonLoveSongsAccountedFor = Object.entries(songCountByLoveSongType).reduce(
    ...
    $: sortedSongTypes = Object.entries(typesMarkedAsNonLoveSongsAccountedFor).sort((a, b) => b[1] - a[1]);
</script>
