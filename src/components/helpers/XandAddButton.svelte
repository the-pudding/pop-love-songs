<script>
    ...
    export let rotateIntoPlusSign = false;
    export let diameter;
    ...
    $: style = `
        transform: rotate(${rotateIntoPlusSign ? 45 : 0}deg) ${transformProperties};
        height: ${diameter}px;
        width: ${diameter}px;
        background-color: ${isSelected ? selectionColor : variables.color['cream-background']};
